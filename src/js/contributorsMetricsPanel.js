...
(function ($, fluid) {
    ...
    fluid.defaults("gpii.qualityInfrastructure.frontEnd.contributorsMetricsPanel", {
        ...
        resources: {
            template: {
                resourceText: "<div class=\"gpiic-metricsPanel-summary\"><h2>Loading Contributors Metrics...</h2></div><div class=\"gpiic-metricsPanel-graph\"><h3>Amount of Contribution</h3></div>"
            }
        },
        components: {
            summary: {
